...
// 主颜色
const $mainColor = "#4a9fe1";
// 弹窗图标url
const $iconUrl = "/static/img/update_bg.png";
...
function updatePopup(data, callback) {
    ...
    // 描述的列表
    const descriptionList = drawtext(data.remark||"版本升级", viewContentWidth);
...
export default function (isPrompt = false) {
    plus.runtime.getProperty(plus.runtime.appid, function (wgtinfo) {
        ...
        //     appType: platform
        // }).then(editionInfo => {
        //     console.log("Xxxxxxxxxxxx", editionInfo)
        //     if (!editionInfo.isCur) {
        //         updatePopup(editionInfo, function () {
        //             if (platform === 'android') {
        //                 getDownload(editionInfo);
        //             } else{
        //                 plus.runtime.openURL(editionInfo.apkSrc);
        //             }
        //         });
        //     } else {
        //         // uni.showToast({
