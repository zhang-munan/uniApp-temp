export default {
    ...
    methods: {
        ...
        getUnit(unit = '') {
            ...
            return uni.$d.trim(unit).split(' ').map((item) => uni.$d.addUnit(item)).join(' ')
        }
    }
}
